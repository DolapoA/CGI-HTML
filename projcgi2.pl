...
# search. On this intial results page the user is given the option to view 		
# details about the gene. The purpose of this script is to present these 		
...
# the raw sequence.                                                                     
#   Note:                                                                               
#   Highlighting colour: #FF0000 = blue                                                  
...
# subroutines from the cal.pm module namely connect_exons and protein_spacing.	
